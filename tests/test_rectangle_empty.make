...
TARGET = $(TARGETDIR)/test_rectangle_empty
OBJDIR = ../bin-int/linux-x86_64/Debug/tests/test_rectangle_empty
DEFINES += -D_DEBUG
...
TARGET = $(TARGETDIR)/test_rectangle_empty
OBJDIR = ../bin-int/linux-x86_64/Release/tests/test_rectangle_empty
DEFINES += -DNDEBUG
...
TARGET = $(TARGETDIR)/test_rectangle_empty
OBJDIR = ../bin-int/linux-x86_64/Dist/tests/test_rectangle_empty
DEFINES +=
...
GENERATED += $(OBJDIR)/test_rectangle_empty.o
OBJECTS += $(OBJDIR)/test_rectangle_empty.o
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking test_rectangle_empty
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_rectangle_empty
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/test_rectangle_empty.o: geometry/test_rectangle_empty.cpp
	@echo "$(notdir $<)"
