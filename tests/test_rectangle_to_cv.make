...
TARGET = $(TARGETDIR)/test_rectangle_to_cv
OBJDIR = ../bin-int/linux-x86_64/Debug/tests/test_rectangle_to_cv
DEFINES += -D_DEBUG
...
TARGET = $(TARGETDIR)/test_rectangle_to_cv
OBJDIR = ../bin-int/linux-x86_64/Release/tests/test_rectangle_to_cv
DEFINES += -DNDEBUG
...
TARGET = $(TARGETDIR)/test_rectangle_to_cv
OBJDIR = ../bin-int/linux-x86_64/Dist/tests/test_rectangle_to_cv
DEFINES +=
...
GENERATED += $(OBJDIR)/test_rectangle_to_cv.o
OBJECTS += $(OBJDIR)/test_rectangle_to_cv.o
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking test_rectangle_to_cv
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_rectangle_to_cv
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/test_rectangle_to_cv.o: geometry/test_rectangle_to_cv.cpp
	@echo "$(notdir $<)"
