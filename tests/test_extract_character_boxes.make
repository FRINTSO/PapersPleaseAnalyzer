...
TARGET = $(TARGETDIR)/test_extract_character_boxes
OBJDIR = ../bin-int/linux-x86_64/Debug/tests/test_extract_character_boxes
DEFINES += -D_DEBUG
...
TARGET = $(TARGETDIR)/test_extract_character_boxes
OBJDIR = ../bin-int/linux-x86_64/Release/tests/test_extract_character_boxes
DEFINES += -DNDEBUG
...
TARGET = $(TARGETDIR)/test_extract_character_boxes
OBJDIR = ../bin-int/linux-x86_64/Dist/tests/test_extract_character_boxes
DEFINES +=
...
GENERATED += $(OBJDIR)/test_extract_character_boxes.o
OBJECTS += $(OBJDIR)/test_extract_character_boxes.o
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking test_extract_character_boxes
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_extract_character_boxes
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/test_extract_character_boxes.o: ocr/test_extract_character_boxes.cpp
	@echo "$(notdir $<)"
