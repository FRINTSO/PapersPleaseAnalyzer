...
premake_archive_name = f"premake-{premake_version}-{__premake_platform_suffix_table[platform]}"
premake_zip_url = f"https://github.com/premake/premake-core/releases/download/v{premake_version}/{premake_archive_name}"
premake_bin_dir = project_root / "vendor/premake/bin"
premake_archive_dir = str(premake_bin_dir / premake_archive_name)
premake_executable = premake_bin_dir / __premake_platform_executable_name_table[platform]
