...
void test_hsv() {
	...
	cv::createTrackbar("Hue Min", "TrackBars", &hueMin, 179, on_trackbar);
	cv::createTrackbar("Hue Max", "TrackBars", &hueMax, 179, on_trackbar);
	cv::createTrackbar("Sat Min", "TrackBars", &satMin, 255, on_trackbar);
	cv::createTrackbar("Sat Max", "TrackBars", &satMax, 255, on_trackbar);
	cv::createTrackbar("Val Min", "TrackBars", &valMin, 255, on_trackbar);
