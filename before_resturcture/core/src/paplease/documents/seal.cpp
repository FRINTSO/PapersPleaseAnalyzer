...
#include "paplease/utils/hsv_util.h"
	...
	namespace documents {
		...
		static const std::vector<cv::Mat>& LoadDocumentSeals(DocType documentType)
		{
			switch (documentType)
			{
				...
				{
					static const auto seals = LoadDocumentSealsByPath("..\\Paplease-Core\\assets/images/seals/diplomatic_authorization");
					return seals;
				}
				case DocType::EntryPermit:
				{
					static const auto seals = LoadDocumentSealsByPath("..\\Paplease-Core\\assets/images/seals/entry_permit");
					return seals;
				}
				case DocType::AccessPermit:
				{
					static const auto seals = LoadDocumentSealsByPath("..\\Paplease-Core\\assets/images/seals/access_permit");
					return seals;
				}
				case DocType::WorkPass:
				{
					static const auto seals = LoadDocumentSealsByPath("..\\Paplease-Core\\assets/images/seals/work_pass");
					return seals;
				}
				case DocType::GrantOfAsylum:
				{
					static const auto seals = LoadDocumentSealsByPath("..\\Paplease-Core\\assets/images/seals/grant_of_asylum");
					return seals;
				}
			}
