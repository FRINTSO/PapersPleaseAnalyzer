#include "pch.h"
#include "paplease/analysis_v1/doc_tracker.h"
...
namespace paplease {
    namespace analysis_v1 {
		...
		static cv::Mat PreprocessInspectionView(const GameView& view)
		{
			...
			static auto inspectionViewFilter = LoadImageFile("..\\Paplease-Core\\assets\\images\\booth\\inspection_view_filter.png") ^ 255;
